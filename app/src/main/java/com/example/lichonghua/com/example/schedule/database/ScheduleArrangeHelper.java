package com.example.lichonghua.com.example.schedule.database;
...
public class ScheduleArrangeHelper extends DbHelper {
    ...
    public ScheduleArrangeHelper(Context context, String name, SQLiteDatabase.CursorFactory factory,
                                 int version) {
